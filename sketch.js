...
if (keyCode === DOWN_ARROW) 
  { Matter.Body.applyForce(bob5.body,bob5.body.position,{x:40,y:30}); } 

  if (keyCode === LEFT_ARROW) 
	{ Matter.Body.applyForce(bob2.body,bob1.body.position,{x:-40,y:-30}); } 
  
  if (keyCode === RIGHT_ARROW) 
	{ Matter.Body.applyForce(bob4.body,bob1.body.position,{x:40,y:30}); } 
} 
